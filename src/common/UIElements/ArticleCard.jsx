...
const ArticleCard = ({ post }) => {
  ...
  console.log("post.featuredImage.public_id", post.featuredImage.public_id)
  return (
    <VStack my={10} p={4} borderRadius={'xl'} shadow={shadow} h={'max-content'}>
      ...
      <NextLink href={`/${post.slug}`} passHref>
        <Link tabIndex={-1}>
          <Image
            src={buildImage(typeof post.featuredImage.public_id === Object ? post.featuredImage.public_id.public_id : post.featuredImage.public_id)
